...
class Solution {
    public boolean lemonadeChange(int[] bills) {
        ...
        return true; // Successfully provided correct change for all customers
    }
}
 ...
 * 
 * Approach:
 * Keep track of the number of $5 and $10 bills you have.
 * For each customer:
 * If the customer pays with a $5 bill, just add it to your count of $5 bills.
 * If the customer pays with a $10 bill, you need to give back one $5 bill as
 * change, so check if you have one and update the count.
 * If the customer pays with a $20 bill, you need to give $15 as change.
 * Prioritize giving one $10 bill and one $5 bill as change (if available),
